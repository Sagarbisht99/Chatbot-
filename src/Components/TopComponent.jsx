...
const TopComponent = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col sm:flex-row my-10 justify-center items-center gap-4 sm:gap-6">
        <button
        ...
        <button className="bg-[#003366] flex items-center gap-3 text-[#F1F1F1] rounded-[12px] p-4 font-semibold text-lg sm:text-xl hover:bg-[#002244] transition-colors shadow-md w-full sm:w-auto flex items-center justify-center">
